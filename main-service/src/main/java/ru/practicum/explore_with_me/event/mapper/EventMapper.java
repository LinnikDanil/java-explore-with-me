...
public class EventMapper {
    ...
    public static Event toEvent(EventCreateRequestDto eventDto, Category category, User initiator, Location location, LocalDateTime createdOn, EventState eventState) {
