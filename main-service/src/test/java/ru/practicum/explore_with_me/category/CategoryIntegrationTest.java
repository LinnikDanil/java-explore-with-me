...
public class CategoryIntegrationTest {
    ...
    public void fullCategoryIntegrationTest() throws JSONException, IOException {
        ...
        restTemplate.exchange(createURLWithPort("/admin/categories"), HttpMethod.POST, entity2, CategoryResponseDto.class);
        ...
        ResponseEntity<String> responseGetById = restTemplate.exchange(createURLWithPort("/categories/" + categoryResponseDto1.getId()),
                HttpMethod.GET, entity3, String.class);

        String expectedJsonId = String.format("{\"name\":\"Updated Category\",\"id\":%d}", categoryResponseDto1.getId());
